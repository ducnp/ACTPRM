...
WebUI.click(findTestObject('Priem-2 scripts/check elements/table 4 ea '))

WebUI.click(findTestObject('Priem-2 scripts/check elements/table 1'))
...
WebUI.click(findTestObject('Priem-2 scripts/check elements/ex/Plaatsing inrichting voor jeugdigen'))
