...
WebUI.click(findTestObject('Priem-2 scripts/check elements/VOEGING default user'))
...
WebUI.click(findTestObject('Priem-2 scripts/check elements/link add ex a'), FailureHandling.OPTIONAL)
