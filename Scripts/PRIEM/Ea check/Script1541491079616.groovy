...
WebUI.setText(findTestObject('Priem-2 scripts/Parket Zaak EA/date'), '30/11/2018')

WebUI.click(findTestObject('Priem-2 scripts/Parket Zaak EA/Rechtsvorm'))

WebUI.selectOptionByValue(findTestObject('Priem-2 scripts/Rechtsvorm/Rechtsvorm'), '22', false)

WebUI.setText(findTestObject('Priem-2 scripts/Parket Zaak EA/Handelsnaam'), 'aa')
...
WebUI.setText(findTestObject('Priem-2 scripts/Parket Zaak EA/Datum Oprichting'), '030/11/2018')

WebUI.delay(1)

WebUI.setText(findTestObject('Priem-2 scripts/Parket Zaak EA/Datum laatste statutenwijziging'), '030/11/2018')

WebUI.delay(1)

WebUI.setText(findTestObject('Priem-2 scripts/Parket Zaak EA/Datum vestiging'), '030/11/2018')
...
WebUI.click(findTestObject('Priem-2 scripts/eye ea/addr'))

WebUI.click(findTestObject('Priem-2 scripts/eye ea/addr lb click'))
...
WebUI.click(findTestObject('Priem-2 scripts/Contact/close'))
